...
public class SelectorInjection {
    ...
    public SelectorInjection(View view, TypedArray typedArray) {
        mView = view;
        mIsSmart = typedArray.getBoolean(R.styleable.SelectorInjection_in_isSmart, true);

        mNormal = typedArray.getDrawable(R.styleable.SelectorInjection_in_normal_drawable);
        mPressed = typedArray.getDrawable(R.styleable.SelectorInjection_in_pressed_drawable);
        mChecked = typedArray.getDrawable(R.styleable.SelectorInjection_in_checked_drawable);

        mNormalColor = typedArray.getColor(R.styleable.SelectorInjection_in_normal_color, DEFAULT_COLOR);
        mPressedColor = typedArray.getColor(R.styleable.SelectorInjection_in_pressed_color, DEFAULT_COLOR);
        mCheckedColor = typedArray.getColor(R.styleable.SelectorInjection_in_checked_color, DEFAULT_COLOR);

        mStrokeColor = typedArray.getColor(R.styleable.SelectorInjection_in_stroke_color, DEFAULT_COLOR);
        mStrokeWidth = typedArray.getDimensionPixelSize(R.styleable.SelectorInjection_in_stroke_width, DEFAULT_STROKE_WIDTH);
        // 目前还没支持pressed状态下的描边改变，默认是用正常状态下的描边样式
        mCheckedStrokeColor = typedArray.getColor(R.styleable.SelectorInjection_in_checked_stroke_color, DEFAULT_COLOR);
        mCheckedStrokeWidth = typedArray.getDimensionPixelSize(R.styleable.SelectorInjection_in_checked_stroke_width, DEFAULT_STROKE_WIDTH);

        mIsSrc = typedArray.getBoolean(R.styleable.SelectorInjection_in_isSrc, false);
        // typedArray.recycle();
    }
