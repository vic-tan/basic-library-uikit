package com.tlf.basic.uikit.linearlistview;
...
import com.tlf.basic.uikit.linearlistview.internal.IcsLinearLayout;
...
public class LinearListView extends IcsLinearLayout {
	 ...
	 *            backing this mRefreshList and for producing a view to represent an
	...
	/**
	 * Update the status of the mRefreshList based on the empty parameter. If empty is
	...
	private void updateEmptyStatus(boolean empty) {
		if (empty) {
			if (mEmptyView != null) {
				...
				// If the caller just removed our empty view, make sure the mRefreshList
				// view is visible
