package com.tlf.basic.uikit.dialog.internal;
...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog<T> {
     ...
     */
    protected int mBtnPressColor ;// #85D3EF,#ffcccccc,#E3E3E3
    /**
    ...
    public BaseAlertDialog(Context context) {
        ...
        mBtnLeftText = context.getResources().getString(R.string.common_cancel);
        mBtnRightText = context.getResources().getString(R.string.common_enter);
        mBtnMiddleText = context.getResources().getString(R.string.common_continue);
        mLeftBtnTextSize = context.getResources().getDimension(R.dimen.common_dialog_btn_text_size);
        mRightBtnTextSize = context.getResources().getDimension(R.dimen.common_dialog_btn_text_size);
        mMiddleBtnTextSize = context.getResources().getDimension(R.dimen.common_dialog_btn_text_size);
        mBtnPressColor = context.getResources().getColor(R.color.common_prompt_dialog_btn_pressed);// #85D3EF,#ffcccccc,#E3E3E3
        mCornerRadius = context.getResources().getDimension(R.dimen.common_border_radius);
        mBgColor = context.getResources().getColor(R.color.common_prompt_dialog_content_bg);
